function mexexec = mexmake_aem(propensity_file,varargin)
%MEXMAKE_AEM Makefile for MEXAEM.
%   MEXEXEC = MEXMAKE_AEM(P) Makes the AEM-solver with propensity
%   source file P, given as a relative path, and returns the
%   executable file as a function handle.
%
%   MEXEXEC = MEXMAKE_AEM(P,...) accepts additional arguments as
%   property/value-pairs.
%
%   Property     Value/{Default}     Description
%   -----------------------------------------------------------------
%   mexname      string {'mexaem'}   Name of output mex-function, cf.
%                                    "mex -output <mexname>"
