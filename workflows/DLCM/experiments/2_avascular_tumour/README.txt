...
Instructions on running the Avascular tumor simulations

E. Blom 23-09-22

Sample models
    1) AvascularTumor.m - DLCM avascular tumor model from [2].
    2) AvascularTumor_updated.m - DLCM avascular tumor model
    with surface tension and pressure sinks from [1].
    ...
    effective model of the one in AvascularTumor_updated.m [1]
    Plots volumetric growth and solution at 3 predefined times.
    Run final Section to save data and animate full simulation.
...
Analysis
utils/
    stability_analysis.m - symbolic evaluation of analysis in §3.2
                            & Lemma A.3 [1]
    rad_stability.m - symbolic evaluation and visualisation of analysis
                            in §3.1 [1]
